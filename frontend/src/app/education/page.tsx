                ...
                <section className="py-16 bg-accent-50">
                    <div className="max-w-6xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="prose prose-lg max-w-none space-y-12 prose-headings:text-primary-600 prose-h2:text-primary-700 prose-p:text-accent-800 prose-strong:text-revolutionary-700 prose-a:text-primary-600 hover:prose-a:text-primary-800">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-gray-700">
                                            <li>
                                                • <em>Mutual Aid</em> by Dean
                                                Spade
                                            </li>
                                            <li>
                                                • <em>Joyful Militancy</em> by
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-2 text-gray-700">
                                            <li>
                                                • <em>The ABCs of Socialism</em>{' '}
                                                by Jacobin Magazine
                                            </li>
                                            <li>
                                                • <em>Why Marx Was Right</em> by
                                                Terry Eagleton
                                            </li>
                                            <li>
                                                •{' '}
                                                <em>The Socialist Manifesto</em>{' '}
                                                by Bhaskar Sunkara
                                            </li>
                                            <li>
                                                •{' '}
                                                <em>
                                                    Red Star Over the Third
                                                    World
                                                </em>{' '}
                                                by Vijay Prashad
                                            </li>
                            ...
                            {/* Call to Action */}
                            <section className="text-center bg-red-50 p-8 rounded-lg">
                                <h2 className="text-3xl font-semibold text-gray-900 mb-4">
                                    Join the Movement
                                </h2>
                                <p className="text-gray-700 mb-6 max-w-3xl mx-auto">
                                    Political education is just the beginning.
                                    Real change comes through collective action.
                                    Join Das Kitchen and help build the
                                    socialist future we need.
                                </p>
                                <div className="space-y-4 sm:space-y-0 sm:space-x-4 sm:flex sm:justify-center">
                                    ...
                                    <a
                                        href="/about"
                                        className="inline-block border border-red-600 hover:bg-red-50 text-red-600 font-medium py-3 px-6 rounded transition-colors"
                                    >
                                        Learn About Us
                                    </a>
                                </div>
